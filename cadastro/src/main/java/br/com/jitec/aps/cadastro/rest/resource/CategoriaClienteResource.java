...
public class CategoriaClienteResource {
	...
	@APIResponses(value = {
			@APIResponse(responseCode = "201", description = ApiConstants.CATEGORIA_CLIENTE_CREATE_RESPONSE, content = @Content(schema = @Schema(allOf = CategoriaClienteResponse.class))),
			@APIResponse(responseCode = "400", description = ApiConstants.STATUS_CODE_BAD_REQUEST),
