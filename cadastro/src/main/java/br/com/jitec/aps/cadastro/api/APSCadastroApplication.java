...
@OpenAPIDefinition(
	tags = { 
			@Tag(name = CadastroApiConstants.TAG_CATEGORIAS_CLIENTE, description = CadastroApiConstants.TAG_CATEGORIAS_CLIENTE_DESCRIPTION),
	...
	security = {
			@SecurityRequirement(name = "cadastroSecurityScheme")
	},
	components = @Components(
			securitySchemes = {
					@SecurityScheme(securitySchemeName = "cadastroSecurityScheme", type = SecuritySchemeType.HTTP, scheme = "Bearer", bearerFormat = "JWT") 
			}
	)
)
