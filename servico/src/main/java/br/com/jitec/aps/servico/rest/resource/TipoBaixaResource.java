...
@Tag(name = ApiConstants.TAG_TIPO_BAIXA)
@Path("/tipos-baixa")
...
public class TipoBaixaResource {
	...
	@Operation(summary = ApiConstants.TIPO_BAIXA_LIST_OPERATION)
	@APIResponses(value = { @APIResponse(responseCode = "200", description = ApiConstants.TIPO_BAIXA_LIST_RESPONSE),
